...
class Raindrop:
    ...
    def draw(self):
        ...
        pygame.draw.rect(self.screen, (0, 0, 50), (self.x, self.y, 2, 5), 1)
        pass
...
class Hero:
    ...
    def hit_by(self, raindrop):
        ...
        heroHitbox = pygame.Rect(self.x, self.y, self.image_umbrella.get_width(), self.image_umbrella.get_height())
...
class Cloud:
    ...
    def rain(self):
        ...
        drop = Raindrop(self.screen, random.randint(self.x, self.x + self.image.get_width()), self.y + self.image.get_height())
